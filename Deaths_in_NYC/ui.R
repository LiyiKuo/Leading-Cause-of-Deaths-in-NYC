  ...
  dashboardSidebar(width = 300,
        sidebarMenu(
          menuItem('Overview',tabName = 'Trendline',icon = icon("bar-chart"),
            ...
            menuSubItem("Death Count in Male By Race Ethnicity", tabName = "DeathCountInMaleByRaceEthnicity",icon = icon("bar-chart")),
            menuSubItem("Death Count in Female By Race Ethnicity", tabName = "DeathCountInFemaleByRaceEthnicity", icon = icon("bar-chart")),
        ...
        #================= 
            ...
            menuItem("Death Count Age Adjusted", tabName = "DeathByRaceAndGender",icon = icon("area-chart")),
