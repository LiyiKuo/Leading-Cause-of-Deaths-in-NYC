...
dashboardBody(
      ...
      tabItem(tabName = "Trends",
              fluidRow(column(12,plotOutput("Trends")))),
      tabItem(tabName = "Death Count Overview",
              fluidRow(column(12,plotOutput("Death Count Overview")))),
      tabItem(tabName = "Death Count By Gender",
              fluidRow(column(12,plotOutput("Death Count By Gender")))),
      tabItem(tabName = "Death Count By Race Ethnicity",
              fluidRow(column(12,plotOutput("Death Count By Race Ethnicity")))),
      tabItem(tabName = "Leading Cause of Death",
              fluidRow(column(12,plotOutput("Leading Cause of Death")))),
      tabItem(tabName = "Leading Cause of Death By Race Ethnicity",
              fluidRow(column(12,plotOutput("Leading Cause of Death By Race Ethnicity")))),
      
      tabItem(tabName = "Death Count Age Adjusted",
              fluidRow(column(12,plotOutput("Death Count Age Adjusted")))),
      tabItem(tabName = "Death Count Age Adjusted By Race",
              fluidRow(column(12,plotOutput("Death Count Age Adjusted By Race")))),

                                                                                                                                   "Female" = "F"))))),
      tabItem(tabName = "Death Ranking By Race Etihnicity", 
              fluidRow(column(12,plotOutput("Death Ranking By Race Etihnicity"))))
      tabItem(tabName = "Top 7 Leading Death in Hispanic",
              fluidRow(column(12,plotOutput("Top 7 Leading Death in Hispanic"))))
      tabItem(tabName = "Top 7 Leading Death in Asian and Pacific Islanders",
        fluidRow(column(12,plotOutput("Top 7 Leading Death in Asian and Pacific Islanders"))))
      tabItem(tabName = "Top 7 Leading Death in White non-Hispanic",
        fluidRow(column(12,plotOutput("Top 7 Leading Death in White non-Hispanic"))))
      tabItem(tabName = "Top 7 Leading Death in Black non-Hispanic",
        fluidRow(column(12,plotOutput("Top 7 Leading Death in Black non-Hispanic"))))
      tabItem(tabName = "Top 7 Leading Death in Others",
        fluidRow(column(12,plotOutput("Top 7 Leading Death in Others"))))
      ...
      tabItem(tabName = "Death by Heart Disease",
              fluidRow(column(12,plotOutput("TDeath by Heart Disease"))))
      
      tabItem(tabName = "Heart Disease Age Ajusted",
              fluidRow(column(12,plotOutput("Heart Disease Age Ajusted"))))
      
      tabItem(tabName = "Death by Cancer",
              fluidRow(column(12,plotOutput("Death by Cancer"))))
      tabItem(tabName = "Death by Cancer Age Adjusted",
              fluidRow(column(12,plotOutput("Death by Cancer Age Adjusted"))))
